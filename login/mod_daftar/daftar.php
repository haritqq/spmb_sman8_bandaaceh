                            ...
                            ?>
                                <tr>
                                    ...
                                    <!--<td>
                                        ...
                                        <a target="_blank" href="https://api.whatsapp.com/send?phone=62<?= $daftar['no_hp'] ?>&text=Terima kasih telah mendaftar di <?= $setting['nama_sekolah'] ?>. %0A%0ASilahkan Login untuk %2Amengecek dan melengkapi data yang kosong%2A pada laman ppdb.sma8bna.sch.id dengan akun yang telah terdaftar. %0Ausername : *<?= $daftar['nisn'] ?>%2A%0Apassword%20%3A%20%2A<?= $daftar['password'] ?>%2A 
                                        %0A%0APemberitahuan, Kepada orangtua/calon siswa bagi yang belum menyerahkan berkas harap membawa berkas persyaratan demi kelancaran proses verifikasi keaslian data. 
                                        Pastikan semua dokumen lengkap dan sesuai persyaratan. Jika ada pertanyaan, silakan hubungi panitia. 
                                        %0A%0ATerima kasih atas kerja samanya! 🙏
                                        %0APanitia SPMB SMA Negeri 8 Banda Aceh">
                                        <?= $daftar['no_hp'] ?></a>
                                    </td>-->
									
									<td>
                                        <i class="fab fa-whatsapp text-success   "></i>
                                        <a target="_blank" href="https://api.whatsapp.com/send?phone=62<?= $daftar['no_hp'] ?>&text=📩 Pesan WhatsApp untuk Peserta Lolos Jalur Prestasi,
                                        %0A%0A*<?= $daftar['nama'] ?>%2A, selamat! 🎉 
                                        %0A%0AAnda telah *DITERIMA%2A melalui Jalur Prestasi di SMA Negeri 8 Banda Aceh. 
                                        %0A%0ABerikut detail Anda:. 
                                        %0A📌 No. Pendaftaran : *<?= $daftar['no_daftar'] ?>%2A
                                        %0A📌 NISN : *<?= $daftar['nisn'] ?>%2A
                                        %0A📌 NAMA%20%3A%20%2A<?= $daftar['nama'] ?>%2A 
                                        %0A%0A✅ Jangan lupa untuk melakukan verifikasi berkas dan daftar ulang sesuai jadwal yang ditentukan.
                                        %0A%0A📌 Jika ada pertanyaan, silakan hubungi panitia SPMB.
                                        %0A%0ATerima kasih dan selamat bergabung di SMA Negeri 8 Banda Aceh! 🎓🎉
                                        %0APanitia SPMB SMA Negeri 8 Banda Aceh">
                                        <?= $daftar['no_hp'] ?></a>
                                    </td>
