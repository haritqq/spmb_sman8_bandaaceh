    ...
    <div class="col-12 col-sm-12 col-lg-12">
        <div class="card author-box card-primary">
            ...
            <div class="card-header">
                <h2 class="section-title">Info SPMB <?= date('Y') ?></h2>
		...
		<div class="col-lg-4">
				...
				Status Pendaftaran Kamu Saat ini <button class="badge badge-danger"> Sudah Diterima, </button> Silahkan Segera Download dan Print Bukti DAFTAR ULANG
				<?php } ?>
			</div>
