...
<html>
    ...
    <body>
        ...
        <hr>
		<b><center>Formulir Pendaftaran Peserta Didik Baru Tahun 2025/2026</center></b>
		<br>
			...
			<tr>
				...
				<td align="center">:</td>
				<td align="left"><?= substr($siswa['no_daftar'], 0, 8) . '_' . substr($siswa['no_daftar'], 8) ?> </td>
			</tr>
...
$dompdf->render();
$dompdf->stream("PPDB2025_" . $siswa['nama'] . ".pdf", array("Attachment" => false));
exit(0);
?>