    ...
    <div class="col-12 col-sm-8 col-lg-12">
        <div class="card author-box card-primary">
            <div class="card-header">
                <h4>Cetak Bukti Daftar Ulang</h4>
		...
		<div class="col-lg-4">
			...
			<button><p>Dengan Ini Saya Menyatakan dengan sebenar benarnya Bahwa data yang saya kirim adalah <strong>benar dan lengkap sesuai dengan Berkas yang ada</strong>, dan saya bertanggung jawab atas semua data yang telah dikirim melalui Aplikasi ini </p>
				</button>
			</div>
...
<div class="popup-wrapper" id="popup">
	<div class="popup-container bg-green">
		...
		<form action="" method="post" class="popup-form">
			<h3>Info SPMB <?= date('Y') ?></h3>
			<h4>Hai <?= $siswa['nama'] ?> !!</h4>
			<p>Silahkan Konfirmasi Jika anda Tetap Untuk Lanjut di <strong> <?= $setting['nama_sekolah'] ?> !! </strong><br/>
			<strong>Jika tidak melakukan KONFIRMASI hingga melewati batas waktu yang telah ditentukan, Maka di anggap Mengundurkan Diri</strong></p>
