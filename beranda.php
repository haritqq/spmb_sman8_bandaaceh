                    ...
                    <nav class="navbar navbar-expand-lg navbar-light" id="navbar-header">
                        <a class="navbar-brand" href="javascript:;">
                            ...
                            <div class="home-header-text d-none d-sm-block">
                                <h5>SISTEM PENERIMAAN MURID BARU</h5>
                                <h6 style="color: black;"><?= $setting['nama_sekolah'] ?></h6>
                                <h6 style="color: black;">Tahun Ajaran 2025/2026</h6>
                            </div>
                            <span class="logo-mini-unbk d-block d-sm-none">SPMB ONLINE</span>
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                        <div>
                                            ...
                                            <ul>
                                                <li data-animation="animated flipInX" data-delay="0.5s">
                                                    Surat Keterangan Lulus / Surat Aktif
                                                </li>
                                                <li data-animation="animated flipInX" data-delay="1s">
                                                    Ijazah Jenjang Sebelumnya
                                                </li>
                                                <li data-animation="animated flipInX" data-delay="1.5s">
                                                    Kartu Keluarga
                                                </li>
                                                <li data-animation="animated flipInX" data-delay="2s">
                                                    Akta Kelahiran
                                                </li>
                                                <li data-animation="animated flipInX" data-delay="2.5s">
                                                    Scan Raport
                                                </li>
                                            </ul>
                                        </div>
								...
								<div class="card">
									...
									<form id="form-daftar">
										<div class="card-body">
											...
											<div class="form-row">
												<label for="asal">JALUR MASUK</label>
                ...
                <section id="tentang">
                    <div class="container">
                        ...
                        <div class="row">
							...
							<div class="col-sm-6">
                               <p align="center">
                                    <img src="assets/Alur Pendaftaran PPDB.png" align="center" width="600" style="max-width: 90%" />
                                </p>
                            </div>
                        </div>
                    </div>
